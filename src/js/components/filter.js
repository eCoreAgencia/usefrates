class Filter {
	constructor() {
		...
		this.openTheFilterButton = $(".filter-mobile__filter");
	...
	events() {
		...
		this.openTheFilterButton.click(this.openFirstLevel);
	}
	openFirstLevel() {
		let firstLevelFilter = $(".filter-mobile__list");
		firstLevelFilter.fadeToggle();
